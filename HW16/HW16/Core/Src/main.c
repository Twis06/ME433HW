...
#define CONTROL_SAMPLES 400U
#define CONTROL_SEGMENT_SAMPLES 100U
...
static void print_control_log(void)
{
  ...
  printf("index,adc,desired_current_thirds_ma,actual_current_thirds_ma\r\n");
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  if (htim == &htim2)
  {
    ...
    if (state == 1)
    {
      ...
      actual_current = readINA219(INA219_REG_CURRENT);
      if (ina219_ok == 0)
      {
        motor_off();
        state = 0;
